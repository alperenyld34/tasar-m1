...
if(isset($_POST['id'])) {
  $id= $_POST['id'];
    $bilgiGetir = $conn->prepare("Select k.adsoyad, k.tckimlikno, k.adres, k.tel, k.evsahibi, d.daireno, d.blokad from tblpasif k, tbldaire d where k.daireid=d.id and k.id=$id");
    $bilgiGetir->execute();  
