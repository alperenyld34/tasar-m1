...
$odenmeyenUcretlerQuery = $conn-> query("select p.id,p.adsoyad, p.kalanborc, d.daireno, d.blokad from tblpasif p, tbldaire d where p.daireid = d.id");
            ...
            <div class="card my-4">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                  <h6 class="text-white text-capitalize ps-3"> Siteden Ayrılanlar ve Ödeme Durumu </h6> 
                  <i class="material-icons text-success p-2">warning </i><span class="text-success"> Siteden ayrılan kişinin ayrıldığı andaki borcudur. Borcu ödediğinde ödemeler kısmından ödeme yapılması gerekmektedir. </span>
                </div>
              </div>
                  ...
                  <table class="table align-items-center mb-0">
                    <thead>
                      <tr>
                        ...
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Kalan Borç</th>
                        <th class="text-center text-uppercase text-success text-xxs font-weight-bolder opacity-7"> Ödeme </th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php 
                        ...
                        <td>
                          <div class="d-flex px-2 py-1">
                            <div class="d-flex flex-column justify-content-center">
                              <h6 class="mb-0 text-sm"><?php echo "<a href=\"javascript:bilgiGetir(" . $odenmeyenUcretler['id'] . ")\">" . $odenmeyenUcretler['adsoyad'] .  "</a>"; ?> 
                              <button id="ac" class="btn btn-danger" data-toggle="modal" data-target="#bilgi" style="display:none;" ></button></h6>
                              <p class="text-xs text-secondary mb-0"><?php echo $odenmeyenUcretler['blokad']. " Blok " . $odenmeyenUcretler['daireno']." Numara" ?></p>
                            </div>
                          </div>
                        </td>
                        <td>
                          <p class="text-xs font-weight-bold mb-0"><?php  if($odenmeyenUcretler['kalanborc']>0){  echo $odenmeyenUcretler['kalanborc']. " TL"; } else {echo "<span class=\"badge badge-sm bg-gradient-success\">Yoktur</span>"; }  ?></p>
                        </td>
                        <td class="align-middle text-center">
                        <?php 
                        if($odenmeyenUcretler['kalanborc']==0) { ?>
                          <a class="btn btn-link text-info text-gradient px-3 mb-0"><i class="material-icons text-sm me-2">done</i>Borç Yok</a>
                          <?php
                        } else { ?>
