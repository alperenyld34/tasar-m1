...
<div class="container-fluid">
  ...
  <!-- Page Heading -->
  <h1 class="h3 mb-2 text-gray-800">Kiralar</h1>
  <p class="mb-4">Tüm kiraları buradan görebilir ve yönetebilirsiniz.</p>
  <!-- DataTales Giriş -->
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary">Kiralar</h6>
    </div>
    <div class="card-body" style="width: 100%">
      ...
      <div class="mobilgizle gizlemeyiac" style="margin-bottom: 10px;">
        ...
        <button type="button" id="acil" style="margin-bottom: 5px;" class="btn btn-sm btn-danger btn-icon-split">
          ...
          <span class="text">Ödenmeyen</span>
        </button>
          ...
          <td>
            ...
            if (yetkikontrol()=="yetkili") {?>
             <div class="d-flex justify-content-center">
              <form action="daireduzenle.php" method="POST">
                <input type="hidden" name="daire_id" value="<?php echo $dairecek['daire_id'] ?>">
              ...
              <form class="mx-1" action="islemler/islem.php" method="POST">
                <input type="hidden" name="daire_id" value="<?php echo $dairecek['daire_id'] ?>">
                <button type="submit" name="dairesilme" class="btn btn-danger btn-sm btn-icon-split">
                  <span class="icon text-white-60">
            ...
            <?php } ?>
            <form action="daire" method="POST">
              <input type="hidden" name="daire_id" value="<?php echo $dairecek['daire_id'] ?>">
              <button type="submit" name="daire_bak" class="btn btn-primary btn-sm btn-icon-split">
                <span class="icon text-white-60">
