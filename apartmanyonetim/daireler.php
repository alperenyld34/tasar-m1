...
<div class="container-fluid">
  ...
  <!-- Page Heading -->
  <h1 class="h3 mb-2 text-gray-800">Daireler</h1>
  <p class="mb-4">Tüm daireleri buradan görebilir ve yönetebilirsiniz.</p>
  <!-- DataTales Giriş -->
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary">Daireler</h6>
    </div>
